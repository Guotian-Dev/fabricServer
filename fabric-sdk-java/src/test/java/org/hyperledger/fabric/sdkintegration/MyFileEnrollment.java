 ...
 *
 */
public class MyFileEnrollment implements Enrollment, Serializable{
    ...
    MyFileEnrollment(PrivateKey privateKey, String cert) {
    ...
    public static MyFileEnrollment getEnrollmentFromFile(File keyFile, File certFile) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
...
//			System.out.println("***********************");
			...
			return new MyFileEnrollment(privateKey, cert);
    	} catch (IOException e) {
			e.printStackTrace();
			throw e;
